import React, { LegacyRef, ReactElement, useEffect, useReducer, useRef } from "react";
...
export default function Modal({isOpen,onClose,title,children,closeModal,position}:ModalProps) {
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex min-h-full items-center justify-center text-center">
              <Transition.Child
                ...
                leaveTo="opacity-0 scale-95" afterEnter={()=>{
